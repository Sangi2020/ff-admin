<?php return array (
  ...
  'Product VAT/TAX Status (Included/Excluded)' => 'Product GST/TAX Status (Included/Excluded)',
  'excluded' => 'Excluded',
  'included' => 'Included',
  ...
  'Only available when order is out for delivery' => 'Only available when order is out for delivery',
  'razor pay' => 'Razor pay',
  'Want to delete thisss' => 'Want to delete thisss',
  'branch image' => 'Branch image',
  'you_want_to_disable_this_branchv' => 'You want to disable this branchv',
  'vyou_want_to_active_this_branch' => 'Vyou want to active this branch',
  'Want to delete this coupon' => 'Want to delete this coupon',
  'employee' => 'Employee',
  'Want to delete this role' => 'Want to delete this role',
  'Want to remove this customer' => 'Want to remove this customer',
  'not_found' => 'Not found',
  'you_want_to_disable_this_deliveryman' => 'You want to disable this deliveryman',
  'you_want_to_active_this_deliveryman' => 'You want to active this deliveryman',
  ...
  'most_reviewed_product' => 'Most reviewed product',
  'If the status is off most trending product will not show to user.' => 'If the status is off most trending product will not show to user.',
  'trending_product' => 'Trending product',
  'If the status is off most featured product will not show to user.' => 'If the status is off most featured product will not show to user.',
  ...
  'Ramizh Mia' => 'Ramizh Mia',
  687662200987655 => '687662200987655',
  'WE/6565t-666' => 'WE/6565t-666',
  98786867567 => '98786867567',
  'demo@demomerchant.com' => 'Demo@demomerchant.com',
  87675745354365 => '87675745354365',
  'business_setup' => 'Business setup',
  'you want to  this page' => 'You want to  this page',
  'wallet_transactions' => 'Wallet transactions',
  'wallet_bonuses' => 'Wallet bonuses',
  'fav_icon' => 'Fav icon',
  'current\'s Statistics' => 'Current\'s Statistics',
  '- Products imported successfully!' => '- Products imported successfully!',
  'Change status to out for delivery' => 'Change status to out for delivery',
  'identity_image' => 'Identity image',
  'Product unavailable' => 'Product unavailable',
  'Description maximum character length must be 255' => 'Description maximum character length must be 255',
  'guest checkout status updated' => 'Guest checkout status updated',
  'This customer have 3 running order. Please complete the running order first' => 'This customer have 3 running order. Please complete the running order first',
  'This customer have 13 running order. Please complete the running order first' => 'This customer have 13 running order. Please complete the running order first',
  'You have 3 running order. Please complete the running order first' => 'You have 3 running order. Please complete the running order first',
  'Admin password updated successfully!' => 'Admin password updated successfully!',
  'last Name' => 'Last Name',
  'Doe' => 'Doe',
  'John' => 'John',
  'Joe' => 'Joe',
  'analytics_logo' => 'Analytics logo',
  'Waiting for location...' => 'Waiting for location...',
  'Canceled order can not be verified' => 'Canceled order can not be verified',
  'Ex : Search by ID' => 'Ex : Search by ID',
  ...
  'Order Image Label Name' => 'Order Image Label Name',
  'Order Image Status' => 'Order Image Status',
  ...
  'If this field is active the users can add image while placing an order' => 'If this field is active the users can add image while placing an order',
  'Order image label name. (ex: Prescription Image)' => 'Order image label name. (ex: Prescription Image)',
  ...
  'Continue' => 'Continue',
  'Just click on the section to automatically import database' => 'Just click on the section to automatically import database',
  ...
  'groFresh Software Update' => 'GroFresh Software Update',
  ...
  'Must be active Phone Verification when OTP Login is active.' => 'Must be active Phone Verification when OTP Login is active.',
  ...
  'General Delivery Fee Setup' => 'General Delivery Fee Setup',
  'status updated' => 'Status updated',
  ...
  'Please select at least one social media option if Social Media Login is enabled.' => 'Please select at least one social media option if Social Media Login is enabled.',
  'No Social Media Option Selected' => 'No Social Media Option Selected',
  'Phone verification must be active if OTP login is enabled.' => 'Phone verification must be active if OTP login is enabled.',
  'Phone Verification Required' => 'Phone Verification Required',
  'Please select at least one social media option.' => 'Please select at least one social media option.',
  'Pickup status updated' => 'Pickup status updated',
  'partial payment status updated' => 'Partial payment status updated',
  'Delivery man self registration status updated' => 'Delivery man self registration status updated',
  ...
  'Admin/Branch will get a pop-up notification with sounds for every order placed by customers.' => 'Admin/Branch will get a pop-up notification with sounds for every order placed by customers.',
  ...
  'Deliveryman Location' => 'Deliveryman Location',
  ...
  'Gram' => 'Gram',
  'Kilogram' => 'Kilogram',
  'product_weight_type' => 'Product weight type',
  'product_weight_unit_type' => 'Product weight unit type',
  'product_weight_unit' => 'Product weight unit',
  'Gst No' => 'Gst No',
  'charge_on_weight' => 'Charge on weight',
  'Charge_On_Weight' => 'Charge On Weight',
  'Charge' => 'Charge',
  'Charge On Weight' => 'Charge On Weight',
  ...
  'To work properly Weight based delivery charge need to update your product weight from ' => 'To work properly Weight based delivery charge need to update your product weight from ',
  'Add Extra Delivery Charge on Weight' => 'Add Extra Delivery Charge on Weight',
  'To apply a delivery charge based on weight, update the product weight in the product details. Without this, the delivery charge will not work correctly.' => 'To apply a delivery charge based on weight  update the product weight in the product details. Without this  the delivery charge will not work correctly.',
  'Need to Update Product Weight.' => 'Need to Update Product Weight.',
  'Yes, Confirm' => 'Yes  Confirm',
  'Confirm' => 'Confirm',
  'Need to Update Product Weight' => 'Need to Update Product Weight',
  'Setup Charge by Range' => 'Setup Charge by Range',
  'Setup Charge Per Unit' => 'Setup Charge Per Unit',
  'Additional charge per' => 'Additional charge per',
  'Count charge from' => 'Count charge from',
  'Greater' => 'Greater',
  ...
  'Equal' => 'Equal',
  'Max Weight must be greater than Min Weight' => 'Max Weight must be greater than Min Weight',
  'Please enter a value for Max Weight.' => 'Please enter a value for Max Weight.',
  'Max Weight is required before adding a new row' => 'Max Weight is required before adding a new row',
  'Min Weight is required before adding a new row' => 'Min Weight is required before adding a new row',
  'Please enter a value for Min Weight.' => 'Please enter a value for Min Weight.',
  'Please enter positive values for Min Weight and Max Weight.' => 'Please enter positive values for Min Weight and Max Weight.',
  'Weight values must be positive' => 'Weight values must be positive',
  'Rules' => 'Rules',
  'No rules added yet' => 'No rules added yet',
  ...
  'Firebase Auth Verification' => 'Firebase Auth Verification',
  ...
  'Extra delivery charges based on weight will be 0 if the products weight are not within the following weight ranges.' => 'Extra delivery charges based on weight will be 0 if the products weight are not within the following weight ranges.',
  ...
  'Customer Email Verification' => 'Customer Email Verification',
  'Payment' => 'Payment',
