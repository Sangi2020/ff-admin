                                ...
                                @if($config)
                                    <div class="d-flex flex-wrap gap-3 align-items-center">
                                        <p class="mb-0">
                                            ...
                                            @endif
                                                <a class="btn btn-outline-primary btn-sm py-1 px-2 edit square-btn maintenance-mode-show" href="#"><i class="tio-edit"></i></a>
                                        </p>
                                    </div>
                                @else
                            ...
                            <div class="col-md-4">
                                <div class="d-flex justify-content-between align-items-center border rounded mb-2 px-3 py-2">
                                    ...
                                    <label class="toggle-switch toggle-switch-sm">
                                        <input type="checkbox" class="toggle-switch-input @if(!$config) maintenance-mode-show @endif"
                        ...
                        <form action="{{route('admin.business-settings.store.update-setup')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    ?>
                                    <div class="form-group">
                                        <label class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between border rounded px-3 py-0 form-control change-self-pickup-status"
                                ...
                                <div class="col-md-4">
                                    ...
                                    ?>
                                    <div class="form-group">
                                        <label class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between border rounded px-3 py-0 form-control deliveryman-self-registration"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between border rounded px-3 py-0 form-control guest-checkout-status"
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <select name="partial_payment_combine_with" class="form-control">
                                            <option value="COD" {{$combine_with=='COD'?'selected':''}}>{{translate('COD')}}</option>
                                            <option value="digital" {{$combine_with=='digital'?'selected':''}}>{{translate('digital')}}</option>
                                            <option value="offline" {{$combine_with=='offline'?'selected':''}}>{{translate('offline')}}</option>
                                            <option value="all" {{$combine_with=='all'?'selected':''}}>{{translate('all')}}</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 mt-5">
                                    ...
                                    <div class="form-group">
                                        <label class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between border rounded px-3 py-0 form-control">
                                            ...
                                            <input type="checkbox" name="google_map_status" id="google_map_status" class="toggle-switch-input" {{ $google_map == 1 ? 'checked' : '' }}>
                                            <span class="toggle-switch-label text">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                        </label>
                                ...
                                <div class="col-md-4 mt-5">
                                    ...
                                    <div class="form-group">
                                        <label class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between border rounded px-3 py-0 form-control">
                                            ...
                                            <input type="checkbox" name="admin_order_notification" class="toggle-switch-input" id="admin_order_notification" {{ $order_notification == 1 ? 'checked' : '' }}>
                                            <span class="toggle-switch-label text">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                        </label>
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex justify-content-between">
                                            <label class="form-label">{{ translate('Order Notification Type') }}
                                                <span class="form-label-secondary ml-1" data-toggle="tooltip" data-placement="right"
    ...
    <div class="modal fade" id="maintenance-mode-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <form method="post" action="{{route('admin.business-settings.store.maintenance-mode-setup')}}" id="maintenanceModeForm">
                    <?php
                    $selectedMaintenanceSystem = \App\CentralLogics\Helpers::get_business_settings('maintenance_system_setup');
                    $selectedMaintenanceDuration = \App\CentralLogics\Helpers::get_business_settings('maintenance_duration_setup');
                    ...
                    <div class="modal-body">
                        ...
                        <div id="advanceFeatureButtonDiv">
                            <div class="d-flex justify-content-center mt-3">
                                <a href="#" id="advanceFeatureToggle" class="d-block mb-3 maintenance-advance-feature-button">{{ translate('Advance Settings') }}</a>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        <div class="btn--container justify-content-end">
                            ...
                            <button type="button" class="btn btn-primary call-demo" onclick="validateMaintenanceMode()">{{ translate('Save') }}</button>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="text-center">
                        ...
                        <div class="my-4">
                            <a class="btn btn-primary" target="_blank" href="{{ route('admin.business-settings.store.delivery-fee-setup') }}">{{ translate('Go to Delivery Charge Setup') }}</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="text-center">
                        ...
                        <div class="my-4">
                            ...
                            <p>{{ translate('By turning on this option, you can be able to see the map on customer app & website, admin panel, branch panel and deliveryman app. You can now also setup your delivery charges based on distance(km) from ') }}
                                <a class="" target="_blank" href="{{ route('admin.business-settings.store.delivery-fee-setup') }}">{{ translate('This Page') }}</a>
                            </p>
