...
class BusinessSettingsController extends Controller
{
    ...
    public function businessSetup(Request $request): \Illuminate\Http\RedirectResponse
    {
        ...
        $this->businessSettings->updateOrInsert(['key' => 'google_map_status'], [
            'value' => $request['google_map_status'],
        ]);

        $this->businessSettings->updateOrInsert(['key' => 'admin_order_notification'], [
            'value' => $request['admin_order_notification'],
        ]);

        if ($request->has('admin_order_notification_type')){
            $this->businessSettings->updateOrInsert(['key' => 'admin_order_notification_type'], [
    ...
    public function updateFcm(Request $request): RedirectResponse
    {
        ...
        BusinessSetting::query()->updateOrInsert(['key' => 'firebase_message_config'], [
            'value' => json_encode([
    ...
    public function productSetupUpdate(Request $request): \Illuminate\Http\RedirectResponse
    {
        ...
        $this->businessSettings->updateOrInsert(['key' => 'product_weight_unit'], [
    ...
    {
        $this->businessSettings->updateOrInsert(['key' => 'maintenance_mode'], [
        ...
        $this->businessSettings->updateOrInsert(['key' => 'maintenance_system_setup'], [
            'value' => json_encode($selectedSystems)],
        );

        $this->businessSettings->updateOrInsert(['key' => 'maintenance_duration_setup'], [
            'value' => json_encode([
        ...
        $this->businessSettings->updateOrInsert(['key' => 'maintenance_message_setup'], [
            'value' => json_encode([
