...
class UpdateController extends Controller
{
    ...
    public function update_software(Request $request)
    {
        ...
        Helpers::setEnvironmentValue('SOFTWARE_VERSION', '7.5');
        ...
        if (!BusinessSetting::where(['key' => 'product_weight_unit'])->first()) {
            DB::table('business_settings')->updateOrInsert(['key' => 'product_weight_unit'], [
                'value' => 'kg'
            ]);
        }
